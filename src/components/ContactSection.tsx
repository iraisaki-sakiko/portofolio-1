...
const SOCIAL = [
  {
    name: 'GitHub', href: 'https://github.com/riasakiko-collab', color: '#fff',
  ...
  {
    name: 'TikTok', href: 'https://tiktok.com/DhiiXaa15', color: '#ff0050',
  ...
  {
    name: 'Instagram', href: 'https://instagram.com/sasaki15072006', color: '#E1306C',
    ...
    <footer className="py-8 px-4" style={{ borderTop: '1px solid rgba(255,255,255,0.04)' }}>
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-display font-semibold gradient-text">Adhi Parsetia Nugraha</span>
        </div>
        <p className="text-xs font-mono" style={{ color: '#333' }}>
          © {new Date().getFullYear()} Adhi Parsetia Nugraha · Built with React, TypeScript & GSAP · All rights reserved
        </p>
