...
const INFO = [
  { label: 'Nama',       value: 'Adhi Parsetia Nugraha', icon: '✨' },
  { label: 'Umur',       value: '19 Tahun',    icon: '🎂' },
...
const MEDIA_SRC = USE_VIDEO ? '/video.mp4' : '/Adhi.jpg';
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center gap-4 text-center px-6">
                  ...
                  <div>
                    <p className="font-display font-bold text-white text-lg">Adhi Parsetia Nugraha</p>
                  ...
                  <p className="text-xs font-mono" style={{ color: '#2a2a2a' }}>
                    {USE_VIDEO ? 'public/video.mp4' : 'public/Adhi.jpg'}
                  </p>
                </div>
              </div>
            </TiltCard>
            ...
            <div className="flex flex-col gap-4">
              <p className="text-lg leading-relaxed" style={{ color: '#888' }}>
                ...
                <GradientText colors={['#B19EEF', '#5227FF', '#FF9FFC']} animationSpeed={5}>
                  Adhi Parsetia Nugraha
                </GradientText>
                , seorang pelajar berusia 19 tahun yang passionate di dunia web development dan teknologi.
              </p>
